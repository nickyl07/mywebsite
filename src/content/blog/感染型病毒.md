...
![img](https://image-hosting-210.oss-cn-beijing.aliyuncs.com/undefined202602162244734.png)
...
![img](https://image-hosting-210.oss-cn-beijing.aliyuncs.com/undefined202602162244807.png)
...
![image-20260111165114175](https://image-hosting-210.oss-cn-beijing.aliyuncs.com/undefined202602162244735.png)

**金蝉脱壳**：`Self_Delete_Via_Bat`，释放并运行x.bat脚本，删除病毒原始文件，实现自毁伪装。

![image-20260111165209917](https://image-hosting-210.oss-cn-beijing.aliyuncs.com/undefined202602162244736.png)
...
![image-20260104181517432](https://image-hosting-210.oss-cn-beijing.aliyuncs.com/undefined202602162244737.png)

![img](https://image-hosting-210.oss-cn-beijing.aliyuncs.com/undefined202602162244738.png)
...
![image-20260111170200371](https://image-hosting-210.oss-cn-beijing.aliyuncs.com/undefined202602162244739.png)
...
![image-20260104174930926](https://image-hosting-210.oss-cn-beijing.aliyuncs.com/undefined202602162244740.png)

## 后门开启与远程操纵（木马行为）

- **搭建通信后门**：初始化 Socket，绑定 **40118 端口**，将受害主机变为服务端等待连接。

![image-20260111170819106](https://image-hosting-210.oss-cn-beijing.aliyuncs.com/undefined202602162244741.png)

- **C2 指令分发核心**：

  ![image-20260111214618713](https://image-hosting-210.oss-cn-beijing.aliyuncs.com/undefined202602162244742.png)
...
![image-20260111215219692](https://image-hosting-210.oss-cn-beijing.aliyuncs.com/undefined202602162244743.png)

## 全盘收割（感染与加密行为）

*这是感染型病毒最顽固的部分。*

![image-20260111180437882](https://image-hosting-210.oss-cn-beijing.aliyuncs.com/undefined202602162244744.png)

- **遍历策略**：枚举系统所有逻辑驱动器，实现从桌面到全盘（A-Z）的扫描 。

![image-20260111174924688](https://image-hosting-210.oss-cn-beijing.aliyuncs.com/undefined202602162244745.png)

- **双重破坏模式**：
  1. **加密模式（破坏）**：对文件头4096字节进行异或加密，导致数据无法直接读取
  2. **感染模式（传播）**：针对 `.doc`, `.xls`, `.jpg`, `.rar` 进行针对性寄生，触发条件是感染标记**不为** `0xAABBCCDD`的文档，实现病毒扩散。

![image-20260111220200436](https://image-hosting-210.oss-cn-beijing.aliyuncs.com/undefined202602162244746.png)
